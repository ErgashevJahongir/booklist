...
const validationSchema = object().shape({
    email: string().email("Enter the email in the correct format").required("Enter your email"),
...
export default function Register() {
    ...
    const loginMutation = useMutation({
        mutationFn: body => signInRequest(body),
        onSuccess: data => {
            if (data.isOk) {
                setUser(data.data)
    ...
    return (
        <section className="relative flex h-full min-h-screen items-center justify-center py-10">
